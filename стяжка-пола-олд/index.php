...
<?php if (ABTest::instance()->getTestValue('ab_two_versions') === 'new'):  // Если вариант new, то запускается переадресация
   ...
   header("Location: http://фрактал-строй.рф/стяжка-пола/"); // Замените site.ru на адрес сайта, куда будет вести переадресация
   exit();
   endif; ?>
                ...
                <div class="backfon1">
                    <div class="backfon1111">
                        ...
                        <div class="header-contacts">
                            ...
                            <button class="btn-call open-popup-call" onclick="yaCounter38463925.reachGoal('zvonok'); return true;">Заказать обратный звонок</button>
                        </div>
                    </div>		
                </div>	
            </div>
    ...
    <div class="order section">
        <div class="cnt">
            ...
            <form onsubmit="yaCounter31118432.reachGoal('submit'); return true;" method="post" action="mail.php">
                ...
                <button type="submit" class="btn" onclick="yaCounter38463925.reachGoal('Konsul'); return true;">Получить консультацию</button>
                <div class="clear"></div>
            </form>
        </div>
    </div>
        ...
        <div class="cnt clearfix">
            ...
            <div class="consult-right">
                <form onsubmit="yaCounter31118432.reachGoal('submit'); return true;" method="post" action="mail.php">
                    ...
                    <div class="consult-button"><button type="submit" class="btn btn_2" onclick="yaCounter38463925.reachGoal('Konsul_2'); return true;">получить консультацию</button></div>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="cnt">
            <div class="contacts-cnt">
                ...
                <form method="post" action="mail.php" onsubmit="yaCounter31118432.reachGoal('submit'); return true;">
                    ...
                    <button class="btn" type="submit" onclick="yaCounter38463925.reachGoal('Vopros'); return true;">Задать вопрос</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="popup popup-call">
                ...
                <form onsubmit="yaCounter31118432.reachGoal('submit'); return true;" method="post" action="mail.php">
                    ...
                    <div class="popup-button">
                        <button class="btn" type="submit" onclick="yaCounter38463925.reachGoal('Konsul_3'); return true;">Получить консультацию</button>
                    </div>
                </form>
            </div>
