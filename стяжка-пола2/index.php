...
<script type="text/javascript" src= "//n7m9g9p3.ssl.hwcdn.net/s/r/single/57b17b188ac754364043c281.js?v=1"></script>


	<title>ФракталСтрой</title>
<script src='http://realroi.ru/api/1034/js/'></script>
                ...
                <div class="backfon1">
                    <div class="backfon1111">
                        ...
                        <div class="header-contacts">
                            ...
                            <button class="btn-call open-popup-call" onclick="(function(){new Image().src='//tracker.maxymizely.com/Default.aspx?siteid=1018041839&cmpgid=1018161947&ei=&di=&cfid=1&jav=0&sw=800&sh=600&cd=32&lz=-180&enc=true&cp=1&at=3&ap=%7EFjkq%60kq%3F%22Fjks%60wvljk%25ul%7D%60i%22x'})(); yaCounter38463925.reachGoal('zvonok'); return true;">Заказать обратный звонок</button>
                        </div>
                    </div>		
                </div>	
            </div>
    ...
    <div class="grab section">
        <div class="cnt">
            <div class="grab-title">
                <?php echo $main_title;?>
<br><br>
<span class="disc" style=" font-family: Open Sans; font-size: 23px; font-weight: 700; line-height: 1; margin-bottom: 18px;text-transform: none; ">
«Сэкономим до 10% за счет наших эксклюзивных скидок</span>
<p class="disc2" style=" font-family: Open Sans; font-size: 23px; font-weight: 700; line-height: 1; margin-bottom: 18px;    text-transform: none; ">
 у 14 ведущих производителей материалов»</p>
            </div>
    ...
    <div class="order section">
        <div class="cnt">
            ...
            <form onsubmit="yaCounter31118432.reachGoal('submit'); return true;" method="post" action="mail.php">
                ...
                <button type="submit" class="btn" onclick="(function(){new Image().src='//tracker.maxymizely.com/Default.aspx?siteid=1018041839&cmpgid=1018161947&ei=&di=&cfid=1&jav=0&sw=800&sh=600&cd=32&lz=-180&enc=true&cp=1&at=3&ap=%7EFjkq%60kq%3F%22Fjks%60wvljk%25ul%7D%60i%22x'})(); yaCounter38463925.reachGoal('Konsul'); return true;">Получить консультацию</button>
                <div class="clear"></div>
            </form>
        </div>
    </div>
        ...
        <div class="cnt clearfix">
            ...
            <div class="consult-right">
                <form onsubmit="yaCounter31118432.reachGoal('submit'); return true;" method="post" action="mail.php">
                    ...
                    <div class="consult-button"><button type="submit" class="btn btn_2" onclick="(function(){new Image().src='//tracker.maxymizely.com/Default.aspx?siteid=1018041839&cmpgid=1018161947&ei=&di=&cfid=1&jav=0&sw=800&sh=600&cd=32&lz=-180&enc=true&cp=1&at=3&ap=%7EFjkq%60kq%3F%22Fjks%60wvljk%25ul%7D%60i%22x'})(); yaCounter38463925.reachGoal('Konsul_2'); return true;">получить консультацию</button></div>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="cnt">
            <div class="contacts-cnt">
                ...
                <form method="post" action="mail.php" onsubmit="yaCounter31118432.reachGoal('submit'); return true;">
                    ...
                    <button class="btn" type="submit" onclick="(function(){new Image().src='//tracker.maxymizely.com/Default.aspx?siteid=1018041839&cmpgid=1018161947&ei=&di=&cfid=1&jav=0&sw=800&sh=600&cd=32&lz=-180&enc=true&cp=1&at=3&ap=%7EFjkq%60kq%3F%22Fjks%60wvljk%25ul%7D%60i%22x'})(); yaCounter38463925.reachGoal('Vopros'); return true;">Задать вопрос</button>
                </form>
            </div>
        </div>
    </div>
